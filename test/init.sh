...
/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 create account eosio bancordexapi EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF
/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 create account eosio eosio.code EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF
/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 create account eosio eosio.admin EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF

/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 create account eosio eosio.token EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF
/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 create account eosio bancordexbac EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF
/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 create account eosio eosio.rmb EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF

/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 create account eosio eosio.a EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF
/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 create account eosio eosio.b EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF
/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 create account eosio eosio.c EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF
/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 create account eosio zhaojingdong EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF
...
#/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 set account permission bancordexapi active '{"threshold": 1,"keys": [{"key":"EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF", "weight":1}],"accounts": [{"permission":{"actor":"bancordexapi","permission":"eosio.code"},"weight":1}]}' owner -p bancordexapi@owner

#/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 set account permission eosio.token active '{"threshold": 1,"keys": [{"key":"EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF", "weight":1}],"accounts": [{"permission":{"actor":"eosio.token","permission":"eosio.code"},"weight":1}]}' owner -p eosio.token@owner

#/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 set account permission bancordexbac active '{"threshold": 1,"keys": [{"key":"EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF", "weight":1}],"accounts": [{"permission":{"actor":"bancordexapi","permission":"eosio.code"},"weight":1}]}' owner -p bancordexbac@owner

#/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 set account permission eosio.a active '{"threshold": 1,"keys": [{"key":"EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF", "weight":1}],"accounts": [{"permission":{"actor":"bancordexapi","permission":"eosio.code"},"weight":1}]}' owner -p eosio.a@owner

#/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 set account permission eosio.b active '{"threshold": 1,"keys": [{"key":"EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF", "weight":1}],"accounts": [{"permission":{"actor":"bancordexapi","permission":"eosio.code"},"weight":1}]}' owner -p eosio.b@owner

#/usr/local/eosio/bin/cleos --wallet-url http://127.0.0.1:8900 --url http://127.0.0.1:8888 set account permission eosio.c active '{"threshold": 1,"keys": [{"key":"EOS6XUCKZygRxAar38xEQWQsb5ynaGpbCok6JixDBT1wp7ALkpuGF", "weight":1}],"accounts": [{"permission":{"actor":"bancordexapi","permission":"eosio.code"},"weight":1}]}' owner -p eosio.c@owner
